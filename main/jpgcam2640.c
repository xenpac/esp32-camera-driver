...
This software is based on esp-idf version 3.3.1, the long term support version until 2022
git clone -b v3.3.1 --recursive https://github.com/espressif/esp-idf.git

march 2021, Thomas Krueger, Hofgeismar Germany (all rights reserved)
*/
...
// get the camera going
    ...
    ret=camera_init(); //call camdrv, init
    if (ret != ESP_OK)
    {
